        ...
        <div class="card">
            ...
            <div class="form-group row mb-0">
                        ...
                        <div class="col-sm-8 mb-2">
                            <input type="text" class="form-control form-control-sm" name="tgl_input" value="<?php echo  date("j F Y");?>">
                        </div>
                        ...
                        <div class="col-sm-8 mb-2">
                            <input type="number" class="form-control form-control-sm" id="harga_barang" onchange="total()"
                             value="<?php echo $row['harga_barang'];?>" name="harga_barang">
                        </div>
...
function format_ribuan ($nilai){
    return number_format ($nilai, 0, ',', '.');
            ...
            <form method="POST">
                <div class="form-group row mb-0">
                <input type="hidden" class="form-control" name="no_transaksi" value="<?php echo $kodeCart; ?>">
                <input type="hidden" class="form-control" value="<?php echo $tot_bayar; ?>" id="hargatotal">
        ...
        echo "$notransaksi";
          ...
          <hr class="mt-0">
              ...
              <div class="col-sm-12 mt-3 text-center">
                  <p>* TERIMA KASIH TELAH BERBELANJA di GanSTORE PEDIA*</p>
              </div>
              </div>
          </div>
      </div>
